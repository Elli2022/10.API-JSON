...
// Hämta info om ett öl som passar till Caramel toffee cake och presentera namn, tagline och image.
...
console.log(beerJsonObj[0]);


//namn
const nameEl = document.createElement('p');
document.body.appendChild(nameEl);
nameEl.innerText = beerJsonObj[0].name;
console.log(nameEl);
...
taglineEl.innerText = beerJsonObj[0].tagline;
